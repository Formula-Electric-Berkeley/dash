...
const Storage = () => {
    ...
    useEffect(() => {
        fetch("https://ev.studentorg.berkeley.edu/dash-backend/run.fcgi/get_db_size_usage", {
            method: "GET",
        })
    ...
    const deleteDataRecord = (deleteRecordID, deleteRecordFilename, deleteRecordUploadDate) => {
        if (window.confirm(`Are you sure you want to delete this data?\nThis action cannot be undone.\n
            ...
            fetch("https://ev.studentorg.berkeley.edu/dash-backend/run.fcgi/delete?id=dashdata" + deleteRecordID, {
                method: "GET",
            })
                .then((response) => response.json())
                .then((data) => {
