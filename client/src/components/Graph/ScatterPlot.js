...
const ScatterPlot = (props) => {
    ...
    useEffect(() => {
        fetch("https://ev.studentorg.berkeley.edu/dash-backend/run.fcgi/get_column_data?column=col" + props.xColumnName + "&id=" + dataId, {
            method: "GET",
        })
        ...
        fetch("https://ev.studentorg.berkeley.edu/dash-backend/run.fcgi/get_column_data?column=colgyroxs&id=" + dataId, {
            method: "GET",
        })
            .then((response) => response.json())
            .then((data) => {
    ...
    useEffect(() => {
        ...
        for (const yColumnName of yColumnNamesTmp) {
            fetch("https://ev.studentorg.berkeley.edu/dash-backend/run.fcgi/get_column_data?column=col" + yColumnName + "&id=" + dataId, {
                method: "GET",
            })
                .then((response) => response.json())
                .then((data) => {
