...
def graph():
    ...
    source_document = db.dash_data_collection.find_one(
        {"_id": ObjectId(source_id)})

    graph_data = {
        "timestamps": source_document["timestamps"], "data": source_document[parameter]}
...
def storage():
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            insert_header_result = db.dash_headers_collection.insert_one(
                data_header)
